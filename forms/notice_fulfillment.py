...
PDF_PATH = os.path.join(
    os.path.dirname(__file__), "124.pdf"
)


def fill_notice_fulfillment_pdf(data: dict) -> bytes:
    """Fill OREA Form 124 Notice of Fulfillment PDF and return bytes."""
    ...
    fields = {
        ...
        "txtAddSchedule": s(g("conditions_fulfilled")),
